...
let callNews = (search, page) => {
    fetch(`https://api.worldnewsapi.com/search-news?api-key=467f6ec2212641998a1066d322368935&text=${search}&offset=${page ? page : 0}&number=12`)
        .then(res => res.json())
        .then(res => {
            console.log(res)
        ...
        <div class="card mt-2" style="width: 18rem;">
                <img src="${image}" class="news-img card-img-top" alt="IMG">
